...
fn gen_asm(nd:Box<Node> ){
    ...
    match nd.kind{
        ...
        _ => {
            ...
            match nd.kind {
                // + a0=a0+a1
                NodeKind::NdAdd => { println!("   add a0, a0, a1");return;},
                // - a0=a0-a1
                NodeKind::NdSub => { println!("   sub a0, a0, a1");return;},
                // * a0=a0*a1
                NodeKind::NdMul => { println!("   mul a0, a0, a1");return;},
                // / a0=a0/a1
                NodeKind::NdDiv => { println!("   div a0, a0, a1");return;},
